...
if (filter_input(INPUT_POST, "txtEmailRegistro", FILTER_UNSAFE_RAW)) {

    $usuario = new Usuario(); //Instância de usuário

    $usuario->setNome(filter_input(INPUT_POST, "txtNomeRegistro", FILTER_UNSAFE_RAW));
    $usuario->setEmail(filter_input(INPUT_POST, "txtEmailRegistro", FILTER_UNSAFE_RAW));
    $usuario->setSenha(md5(filter_input(INPUT_POST, "txtSenhaRegistro", FILTER_UNSAFE_RAW)));
    ...
    switch ($result) {
        case 1:
            ...
            break;
        case -1:
            $msg = "<div class='alert alert-warning'>Usuário ja estar cadastrado! </div>";
            break;
        case -2:
...
if (filter_input(INPUT_POST, "txtEmailLogin", FILTER_UNSAFE_RAW)) {
    $usuario = $usuarioController->Autenticar(filter_input(INPUT_POST, "txtEmailLogin", FILTER_UNSAFE_RAW), filter_input(INPUT_POST, "txtSenhaLogin", FILTER_UNSAFE_RAW));
    if ($usuario != null) {
        ...
        $msg = "<div class='alert alert-warning'>Usúario ou senha inválido! </div>";
    }
}
?>
<!DOCTYPE html>
